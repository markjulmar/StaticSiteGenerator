...
namespace XamU.SGL.Extensions.MarkdownDeep
{
    public class LinkDefinition
    {
        ...
        internal void RenderLink(Markdown m, StringBuilder b, string link_text, SpecialAttributes attrs)
        {
        ...
        internal void RenderImg(Markdown m, StringBuilder b, string altText, SpecialAttributes attrs)
        {
