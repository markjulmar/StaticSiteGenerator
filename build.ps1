...
# Get the pre-release NuGet v4 to offer MSBuild15 support
...
# Start Cake
# TODO: When all add-ins are Cake v0.22 compatible, we can remove the `--settings_skipverification=true` parameter.
